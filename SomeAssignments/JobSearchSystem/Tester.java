...
public class Tester {
	public static void main(String[] args) {
		...
		Person person1 = new Person("Arya", "female", "Cork");
		person1.addSkill("Computer graphics", 2, true);

		Person person2 = new Person("John", "pefers not to say", "Cork");
		person2.addSkill("Constraint Programming", 6, true);

		Person person3 = new Person("Rory", "male", "Dublin");
		person3.addSkill("NLP", 5, true);

		Person person4 = new Person("Brian", "male", "Kerry");
		person4.addSkill("Optimization", 5, true);

		Person person5 = new Person("John", "male", "Cork");
		...
		Person person6 = new Person("John", "pefers not to say", "Cork");
